...
<main id="primary" class="site-main">
    ...
    <section class="alt-hero technology-hero reveal"
        style="background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(<?php echo get_template_directory_uri(); ?>/assets/relacionIA-humano2.png) no-repeat center center !important; background-size: cover !important;">
