...
function dtv_theme_assets()
{
    ...
    // 2. Main CSS
    wp_enqueue_style('dtv-main-style', get_template_directory_uri() . '/css/landing-v2.css', array('dtv-fonts'), '1.2.2');

    // 3. Theme's style.css
    wp_enqueue_style('dtv-theme-overrides', get_stylesheet_uri(), array('dtv-main-style'), '1.2.2');

    // 4. Common JS
    wp_enqueue_script('dtv-common-js', get_template_directory_uri() . '/js/common.js', array(), '1.2.2', true);
