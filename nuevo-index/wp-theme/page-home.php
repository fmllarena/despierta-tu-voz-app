...
<section class="hero">
    ...
    <div class="hero-content reveal">
        ...
        <div class="hero-btns">
            ...
            <a href="https://app.despiertatuvoz.com/landing.html" class="btn-secondary">Ver cómo funciona</a>
        </div>
    </div>
</section>
...
<section class="comparison reveal" id="comparativa" style="padding: 100px 0; background: #fffaf5;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 20px; text-align: center;">
        <span class="alt-tag">Diferenciación Única</span>
        <h2 style="margin-bottom: 20px;">¿Por qué no basta con un chat genérico?</h2>
        <p style="color: #666; margin-bottom: 50px;">Gemini o ChatGPT son excelentes para tareas generales, pero tu voz
            necesita un Mentor con memoria de proceso y alma técnica.</p>

        <div class="comparison-table"
            style="background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(142,125,109,0.1); border: 1px solid #e2d9cd;">
            <div class="comp-row comp-header"
                style="display: grid; grid-template-columns: 1fr 1fr 1fr; background: #8e7d6d; color: white; padding: 20px; font-weight: 600;">
                <div>Característica</div>
                <div>Mentor DTV ✨</div>
                <div>Chats Genéricos</div>
            </div>

            <div class="comp-row"
                style="display: grid; grid-template-columns: 1fr 1fr 1fr; padding: 25px 20px; border-bottom: 1px solid #f0e6da;">
                <div style="font-weight: 600; color: #1a1a1a;">Especialización</div>
                <div style="color: #8e7d6d; font-weight: 600;">Vertical (30 años de éxito real)</div>
                <div style="color: #999;">Generalista (Puede "alucinar")</div>
            </div>

            <div class="comp-row"
                style="display: grid; grid-template-columns: 1fr 1fr 1fr; padding: 25px 20px; border-bottom: 1px solid #f0e6da; background: #fffcf9;">
                <div style="font-weight: 600; color: #1a1a1a;">Estructura</div>
                <div style="color: #8e7d6d; font-weight: 600;">Un Viaje de 5 Módulos</div>
                <div style="color: #999;">Charla sin fin ni metas claras</div>
            </div>

            <div class="comp-row"
                style="display: grid; grid-template-columns: 1fr 1fr 1fr; padding: 25px 20px; border-bottom: 1px solid #f0e6da;">
                <div style="font-weight: 600; color: #1a1a1a;">Análisis Progresivo</div>
                <div style="color: #8e7d6d; font-weight: 600;">Memoria Afectiva y Técnica</div>
                <div style="color: #999;">Memoria plana de texto</div>
            </div>

            <div class="comp-row"
                style="display: grid; grid-template-columns: 1fr 1fr 1fr; padding: 25px 20px; background: #fffcf9;">
                <div style="font-weight: 600; color: #1a1a1a;">Emergencias</div>
                <div style="color: #8e7d6d; font-weight: 600;">Botiquín y Música integrada</div>
                <div style="color: #999;">Requiere dar contexto cada vez</div>
            </div>
        </div>

        <div style="margin-top: 40px;">
            <p style="font-style: italic; color: #8e7d6d;">"Es la diferencia entre preguntar a una enciclopedia o
                entrenar con un Maestro."</p>
        </div>
    </div>
</section>
...
<section class="recorrido reveal" id="proceso">
    <div class="recorrido-container">
        ...
        <p class="recorrido-intro">Cuando te adentras en mi método, recorres 5 etapas diseñadas para llevarte
...
<section class="nudo-section reveal" id="filosofia">
    ...
    <div class="nudo-checklist">
        ...
        <div class="nudo-item">
            <span class="checkpoint">✓</span>
            <p><strong>Radar de Energía:</strong> Mi tecnología analiza la estabilidad y energía de tu vibración
