...
const MENSAJE_BIENVENIDA = `<p>Hola, ¿qué tal? Soy tu Mentor Vocal privado.</p><br><p>Bienvenido/a a un espacio privado donde tu voz es el puente entre tu técnica y tu alma. 
    ...
    async signUp() {
        ...
        if (error) {
            ...
            if (data?.user) {
                ...
                // Enviar email de verificación para usuarios FREE
                try {
