# Plantilla Email Brevo: Lanzamiento Pioneros - Día 1 (Re-conexión)
# Despierta tu Voz

---

## ASUNTO DEL EMAIL:
🌿 {{ params.NOMBRE }}, te debía una respuesta (y el camino ha sido increíble)
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 40px 40px;">
                            ...
                            <div style="color: #5a5a5a; font-size: 16px; line-height: 1.7; margin: 0 0 30px;">
                                <p>Te escribo porque hace aproximadamente un año mostraste interés en liberar tu voz a través del trabajo emocional. En aquel momento nos cruzamos en un webinar, y quizás agendaste una llamada o quizás el día a día hizo que nos perdiéramos la pista.</p>
                                ...
                                <p>Quiero que seas parte de esta primera comunidad de valientes que van a transformar su comunicación con esta herramienta. Mañana te enviaré los detalles y un acceso que nunca volverá a repetirse.</p>
                                
                                <p>Hoy solo quería decirte: <strong>gracias por esperar</strong>. El camino ha valido la pena.</p>
                                
                                <p>Atento a tu bandeja de entrada mañana,</p>
                            </div>

                            <p style="color: #4a3f35; font-size: 16px; margin: 30px 0 0; font-weight: bold;">
                                Fernando Martínez Llarena
                            </p>
                            <p style="color: #8e7d6d; font-size: 14px; margin: 5px 0 0;">
                                Creador de Despierta tu Voz
                            </p>
...
1. **{{ params.NOMBRE }}** - Nombre del suscriptor (extraído de tu CSV)

---

## INSTRUCCIONES:
1. Copia este código HTML en una nueva plantilla en Brevo llamada "Lanzamiento Pioneros - Día 1".
2. Úsala para el primer envío masivo a la lista de 939 contactos.
